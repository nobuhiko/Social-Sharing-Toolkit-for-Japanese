...
class MR_Social_Sharing_Toolkit {
	...
	function MR_Social_Sharing_Toolkit() {
        ...
        /* for japanese */
		$this->share_buttons['ha_hatebu'] = array('icon' => 'divider', 'title' => 'Hatebu', 'types' => array('none', 'horizontal', 'vertical'));
		$this->share_buttons['gr_grow'] = array('icon' => 'divider', 'title' => 'Grow!', 'id' => 'apikey', 'types' => array('horizontal', 'vertical'));
...
// ###
		...
		if ($this->options['mr_social_sharing_position'] != 'none' && $this->options['mr_social_sharing_buttons']['gr_grow']['enable'] == 1 && in_array($this->options['mr_social_sharing_buttons']['gr_grow']['type'], array('horizontal','vertical'))) {
			$grow_script = true;
		}
		...
		if ($grow_script) {
		    wp_enqueue_script('Grow', 'http://growbutton.com/javascripts/button.js?apikey='.$this->options['mr_social_sharing_widget_buttons']['gr_grow']['id'].'&insert=false', array(), false, true);
		}
	...
	function get_ha_hatebu($url, $title, $type, $id) {
		switch ($type) {
            case 'horizontal':
                $mode = 'standard';
				break;
        ...
        $retval = '
            <a href="http://b.hatena.ne.jp/entry/'. urlencode($url) .'" class="hatena-bookmark-button" data-hatena-bookmark-layout="'.$mode.'" title="'.$title.'"><img src="http://b.st-hatena.com/images/entry-button/button-only.gif" alt="このエントリーをはてなブックマークに追加" width="20" height="20" style="border: none;" /></a><script type="text/javascript" src="http://b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"></script>
            ';
	...
	function get_gr_grow($url, $title, $type, $id) {
